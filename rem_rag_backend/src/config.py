...
ARTICLE_SUMMARY_PROMPT = """Summarize this article in exactly 2 substantial paragraphs (200-250 words total).

First paragraph: Present the main argument, thesis, or central issue the article addresses. Include key facts, events, or developments discussed.

Second paragraph: Explain the implications, conclusions, or broader significance of the article's analysis. What solutions, predictions, or insights does it offer?

Be direct and specific. Do not use meta-commentary like "the article argues" or "the author suggests" - state the ideas directly as facts and analysis.
